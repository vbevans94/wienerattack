...
public class Fraction {
	...
	// Constructor of the Fraction class which initializes the numerator and
	// denominator
	public Fraction(BigInteger paramBigInteger1, BigInteger paramBigInteger2) {
		// find out the gcd of paramBigInteger1 and paramBigInteger2 which is
		// used for ensuring the numerator and denominator are relatively prime
	...
	// Constructor for the case when calculating (paramBigInteger1
	// /(paramFraction.numerator / paramFraction.denominator))
	...
	// Calculate the remainder of this Fraction and assign the result to form a
	// new Fraction
